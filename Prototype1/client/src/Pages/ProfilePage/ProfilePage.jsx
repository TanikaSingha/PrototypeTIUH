    ...
    <section className="py-4 px-8 bg-gray-950 text-gray-200 min-h-screen">
      ...
      <div className="w-full m-4 flex flex-col lg:flex-row lg:items-center gap-6">
        ...
        <div className="div1 w-full md:w-[60%] lg:w-[40%] h-auto md:h-[36rem] lg:h-[38rem] bg-gradient-to-b from-teal-700 via-blue-800 to-indigo-600 p-6 rounded-lg shadow-lg">
          <div className="m-4">
            <h2 className="audiowide text-2xl tracking-wide mb-4 text-white">Account Details</h2>
            <div className="flex items-center gap-6">
              ...
              />
              <div>
                <p className="text-lg font-light montserrat text-white">Name: Tanika Sakya Singha</p>
                <p className="text-lg font-light montserrat text-white">Username: {user.username}</p>
                <p className="text-lg font-light montserrat text-white">Email: {user.email}</p>
              </div>
            </div>
        ...
        <div className="div2 mx-6 w-full md:w-[60%] lg:w-[60%] h-auto md:h-[36rem] lg:h-[38rem] p-6 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2 gap-8 text-white">
          <div className="p-4 bg-gradient-to-b from-blue-900 to-blue-700 rounded-lg">
            <div className="flex flex-col items-center">
              <h3 className="text-lg montserrat font-semibold tracking-wider">Coins Collected</h3>
              <img src={coin} alt="coins" className="h-12 w-12 m-2" />
            </div>
            <p className="inconsolata text-lg text-center mt-4 font-bold">500</p>
          </div>

          <div className="p-4 bg-gradient-to-b from-sky-800 to-sky-600 rounded-lg">
            <div className="flex flex-col items-center">
              <h3 className="text-lg montserrat font-semibold tracking-wider">Score</h3>
              <img src={score} alt="score" className="h-12 w-12 m-2" />
            </div>
            <p className="inconsolata text-lg text-center mt-4 font-bold">1200</p>
          </div>

          <div className="p-4 bg-gradient-to-b from-teal-700 to-teal-500 rounded-lg">
            <div className="flex flex-col items-center">
              <h3 className="text-lg montserrat font-semibold tracking-wider">LeaderBoard Position</h3>
              <img src={leaderboard} alt="leaderboard" className="h-12 w-12 m-2" />
            </div>
            <p className="inconsolata text-lg text-center mt-4 font-bold">15th</p>
          </div>

          <div className="p-4 bg-gradient-to-b from-emerald-600 to-emerald-400 rounded-lg">
            <div className="flex flex-col items-center">
              <h3 className="text-lg montserrat font-semibold tracking-wider">Badges Earned</h3>
              <img src={badges} alt="badges" className="h-12 w-12 m-2" />
            </div>
            <p className="inconsolata text-lg text-center mt-4 font-bold">3</p>
          </div>

          <div className="p-4 bg-gradient-to-b from-cyan-700 to-cyan-500 rounded-lg">
            <div className="flex flex-col items-center">
              <h3 className="text-lg montserrat font-semibold tracking-wider">Current Level</h3>
              <img src={level} alt="level" className="h-12 w-12 m-2" />
            </div>
            <p className="inconsolata text-lg text-center mt-4 font-bold">5</p>
          </div>

          <div className="p-4 bg-gradient-to-b from-indigo-700 to-indigo-500 rounded-lg">
            <div className="flex flex-col items-center">
              <h3 className="text-lg montserrat font-semibold tracking-wider">Groundwater Level</h3>
              <img src={gLevel} alt="groundwater level" className="h-12 w-12 m-2" />
            </div>
            <p className="inconsolata text-lg text-center mt-4 font-bold">90%</p>
          </div>
